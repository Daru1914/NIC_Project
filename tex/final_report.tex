...
\begin{table}[htbp]
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|c|}
			\hline
			\textbf{Test}&\textbf{Inform. range}&\textbf{Redund. range}&\textbf{Imp. acc.}&\textbf{Dec. acc.}&\textbf{Avg. rem. feats} \\
			\hline 
			1& 6-9& 4-6& 3& 0& 5.5 \\
			\hline 
			2& 6-9& 4-6& 7& 0& 5.44 \\
